...
def main(config_path, sigma_in, signal_length, time_point, model_epoch):
    ...
    save_path = f'results_20210203/{model_name}/encoding_dimension/'
    ...
    np.save(os.path.join(save_path, f'correct_ratio.npy'), np.array(correct / 200))

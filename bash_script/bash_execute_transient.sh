...
nohup python -u transient_attractor.py cfg/romo_config/1_var_2.cfg &
nohup python -u transient_attractor.py cfg/romo_config/1_var_3.cfg &

wait

nohup python -u transient_attractor.py cfg/romo_config/1_var_4.cfg &
nohup python -u transient_attractor.py cfg/romo_config/1_var_5.cfg &
nohup python -u transient_attractor.py cfg/romo_config/1_var_6.cfg &

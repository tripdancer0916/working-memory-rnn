...
class RomoDataset(data.Dataset):
    ...
    def __getitem__(self, item):
        ...
        first_signal_timing = np.random.randint(self.time_length - self.signal_length - 5)
        second_signal_timing = np.random.randint(first_signal_timing, self.time_length - self.signal_length)

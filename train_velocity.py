...
def main(config_path):
    ...
    os.makedirs('trained_model/velocity', exist_ok=True)
    save_path = f'trained_model/velocity/{model_name}'
    ...
    train_dataset = VelocityDataset(time_length=cfg['DATALOADER']['TIME_LENGTH'],
                                    time_scale=cfg['MODEL']['ALPHA'],
                                    a_min=cfg['DATALOADER']['A_MIN'],
                                    a_max=cfg['DATALOADER']['A_MAX'],
